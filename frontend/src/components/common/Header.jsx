    ...
    <header className="header">
      <div className="header-container">
        ...
        <nav className="header-nav">
          <Link to={ROUTES.PRODUCTS}     className={`nav-link ${isActive(ROUTES.PRODUCTS)     ? "active" : ""}`}>📦 Inventario</Link>
          <Link to={ROUTES.CREATE_ORDER} className={`nav-link ${isActive(ROUTES.CREATE_ORDER) ? "active" : ""}`}>➕ Registrar Pedido</Link>
